...
/**
 * This will store a collection of LapTimers. All the lap name for the collected LapTimers should be
 * identical for the writeCVS methods to work correctly.
 *
 * @author pat
 */
public class LapTimerCollection {
     ...
     * @param collectionName
     * @param maxTimers
     * @param comparator use this comparator to always sort the list and drop the 'least' LapTimer
     *            as defined by the comparator when adding to a full list.
     */
    ...
    /**
     * This will add a LapTimer to the Collection. If there is now more than the allowed number of
     * LapTimers in the Collection, the Collection will be sorted and the 'least' LapTimer will be
     * removed as determined by the Collection's comparator. The passed LapTimer will never be
     * removed.
     *
     * @param lapTimer
     */
     ...
     *
     * @param name all LapTimers in a Collection should have a name so that they can be tracked
     *            after sorting.
    ...
    /**
     * The name of the LapTimer is the name of this collection combined with the number of LapTimers
     * in this collection (including this LapTimer)
     *
    ...
    /**
     * Write out the collection of LapTimers to output. In CSV (Excel) format.
     *
     * @param output Writer to use to output CSV information
     * @param firstLine if true a header line for column names is displayed
     * @throws IOException
     */
    public void writeCSV(Writer output, boolean firstLine) throws IOException {
        if (firstLine) {
    ...
    /**
     * Sort the LapTimers based on the Comparator passed into the constructor.
     *
     * @return sorted list of laptimers
     */
